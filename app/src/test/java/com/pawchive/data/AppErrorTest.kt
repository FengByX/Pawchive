...
class AppErrorTest {
    ...
    fun `toMessage Network UNREACHABLE returns network unreachable string`() {
        ...
        assertEquals(context.getString(com.pawchive.R.string.error_network_unreachable), message)
    }
    ...
    fun `toMessage Network TIMEOUT returns timeout string`() {
        ...
        assertEquals(context.getString(com.pawchive.R.string.error_timeout), message)
    }

    @Test
    fun `toMessage Server 403 returns forbidden string`() {
        val message = AppError.Server(403).toMessage(context)
        assertEquals(context.getString(com.pawchive.R.string.error_forbidden), message)
    }

    @Test
    fun `toMessage Server 404 returns not found string`() {
        val message = AppError.Server(404).toMessage(context)
        assertEquals(context.getString(com.pawchive.R.string.error_not_found), message)
    }

    @Test
    fun `toMessage Server 500 returns server error string`() {
        val message = AppError.Server(500).toMessage(context)
        assertEquals(context.getString(com.pawchive.R.string.error_server_error), message)
    }
    ...
    fun `toMessage Auth SESSION_EXPIRED returns auth expired string`() {
        ...
        assertEquals(context.getString(com.pawchive.R.string.error_auth_expired), message)
    }

    @Test
    fun `toMessage CloudflareChallenge returns cloudflare string`() {
        val message = AppError.CloudflareChallenge().toMessage(context)
        assertEquals(context.getString(com.pawchive.R.string.error_cloudflare), message)
    }
    ...
    fun `toMessage Unknown returns unknown string`() {
        ...
        assertEquals(context.getString(com.pawchive.R.string.error_unknown), message)
    }
}
