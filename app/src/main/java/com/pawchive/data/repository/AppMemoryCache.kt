 ...
 * 默认缓存条目过期时间：30 分钟。
 */
class AppMemoryCache private constructor() {
    ...
    companion object {
        ...
        @Volatile
        private var instance: AppMemoryCache? = null

        fun getInstance(): AppMemoryCache {
            return instance ?: synchronized(this) {
                instance ?: AppMemoryCache().also { instance = it }
            }
        }
    }
}
